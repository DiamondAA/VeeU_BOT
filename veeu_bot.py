...
def bot(token):
    ...
    if 'user' in jsondata:
        ...
        while True:
            requests.post('https://www.veeuapp.com:443/v1.0/incentive/tasks?access_token=' + token ,data=json.dumps(video),headers=header)
            ...
            for i in range(random.randint(4,10)):
                ...
                requests.post('https://www.veeuapp.com:443/v1.0/incentive/tasks?access_token=' + token ,headers=headlog)
    else:
